...
export const itemsConfiguraciones = [
  ...
  { svg: '', route: 'relojes-precintos-motivos', item: 'Motivos de precintos', permiso:['CONFIGURACIONES_NAV'] },
  { svg: '', route: 'seguros-empresas', item: 'Empresas de seguros', permiso:['CONFIGURACIONES_NAV'] },
];